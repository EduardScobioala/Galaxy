...
class MainWidget(RelativeLayout):
    ...
    from user_action import on_touch_up, on_keyboard_down, on_keyboard_up, on_touch_down, keyboard_closed
    ...
    def init_audio(self):
        ...
        self.sound_game_over_impact.volume = .15
        self.sound_game_over_voice.volume = .4
    ...
    def reset_game(self):
        ...
        self.score_txt = self.score_txt = "SCORE: " + str(self.current_y_loop)
    ...
    def generate_tiles_coordinate(self):
        last_y = 0
        last_x = 0
        # clean coordinate that are out of the screen
        ...
        for i in range(len(self.tiles_coordinates), self.NR_TILES):
            ...
            start_index = -int(self.V_NR_LINES/2) + 1
            end_index = start_index + self.V_NR_LINES - 1
            if last_x <= start_index: r = 1
            if last_x >= end_index: r = 2
    ...
    def init_vertical_lines(self):
        with self.canvas:
            ...
            for i in range(0, self.V_NR_LINES):
                self.vertical_lines.append(Line())

    def get_line_x_from_index(self, index):
        central_line_x = self.perspective_point_x
        spacing = self.V_LINES_SPASING * self.width
        offset = index - 0.5
        line_x = central_line_x + offset*spacing + self.current_offset_x
        return line_x

    def get_line_y_from_index(self, index):
        spasing_y = self.H_LINES_SPASING * self.height
        line_y = index*spasing_y-self.current_offset_y
        return line_y
    ...
    def update_vertical_lines(self):
        ...
        for i in range(start_index, start_index+self.V_NR_LINES):
    ...
    def init_horizontal_lines(self):
        with self.canvas:
            ...
            for i in range(0, self.H_NR_LINES):
    ...
    def update(self, dt):
        ...
        if not self.state_game_over and self.state_game_has_started:
            ...
            spasing_y = self.H_LINES_SPASING * self.height
            while self.current_offset_y >= spasing_y:
                self.current_offset_y -= spasing_y
